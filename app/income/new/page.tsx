...
import { Client, IncomeEntry, InvoiceLine, LineCategory, PaymentMethod, PLATFORM_FEES, Product } from '@/lib/types';
...
export default function NewIncomePage() {
  ...
  const { addEntry, addClient, entries, clients, products } = useStore();
